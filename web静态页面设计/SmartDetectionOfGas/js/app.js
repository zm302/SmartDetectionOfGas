...
$(function(){
//	$('.nav-primary li:has(ul)').addClass('e-sub');
...
$(function(){
	$(".collapse-box:has('.collapse.in')").find(".panel-title a").addClass("arrow-down")

	  $('.collapse-box .panel-heading').click(function(){
		$(".collapse-box").not($(this)).find(".panel-title a").removeClass("arrow-down");
		if($(this).siblings(".panel-collapse").is(".in")) {
		  	$(this).find(".panel-title a").removeClass("arrow-down");
		} else {
		  	$(this).find(".panel-title a").addClass("arrow-down");
		}
	  });
